# Contributing to UKIS-MigrationDetectR

Welcome to `UKIS-MigrationDetectR`. We invite anyone to participate by contributing code, reporting bugs, fixing bugs, writing documentation or discussing the future of this project. As a contributor, here are the guidelines we would like you to follow:
...
Help us keep `UKIS-MigrationDetectR` open and inclusive. Please read and follow our [Code of Conduct](CODE_OF_CONDUCT.md).
...
1. Document your changes in the [Changelog](NEWS.md).
